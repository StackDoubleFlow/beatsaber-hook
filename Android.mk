...
include $(CLEAR_VARS)
LOCAL_MODULE := beatsaber-hook_2_1_1
LOCAL_SRC_FILES += $(call rwildcard,src/utils,*.cpp)
LOCAL_SRC_FILES += $(call rwildcard,src/config,*.cpp)
LOCAL_SHARED_LIBRARIES += modloader
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"2.1.1"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -D'UNITY_2019' -Wall -Wextra -Werror -Wno-unused-function -DID='"beatsaber-hook"' -I'./shared' -isystem 'extern'
